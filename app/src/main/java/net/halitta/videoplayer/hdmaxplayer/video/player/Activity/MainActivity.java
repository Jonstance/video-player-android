...
import net.halitta.videoplayer.hdmaxplayer.video.player.Fragment.FolderFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setUpMenu() {
        ...
        this.itemVideos = new ResideMenuItem(this, (int) R.drawable.ic_baseline_ondemand_video_24, "Video");
        this.itemFolder = new ResideMenuItem(this, (int) R.drawable.ic_baseline_folder_open_24, "Folder");
        ...
        this.itemAboutUs = new ResideMenuItem(this, (int) R.drawable.ic_baseline_supervised_user_circle_24, "About Us");
