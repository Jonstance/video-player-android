package net.halitta.videoplayer.hdmaxplayer.video.player.Adapter;
...
import net.halitta.videoplayer.hdmaxplayer.video.player.Activity.HomeActivity;
import net.halitta.videoplayer.hdmaxplayer.video.player.Activity.SecureActivity;
import net.halitta.videoplayer.hdmaxplayer.video.player.Activity.VideoPlayerActivity;
import net.halitta.videoplayer.hdmaxplayer.video.player.Activity.VideolistActivity;
import net.halitta.videoplayer.hdmaxplayer.video.player.Database.Database;
import net.halitta.videoplayer.hdmaxplayer.video.player.Dialog.VideoDetailsDialog;
import net.halitta.videoplayer.hdmaxplayer.video.player.Extra.MediaData;
import net.halitta.videoplayer.hdmaxplayer.video.player.Model.EventBus;
import net.halitta.videoplayer.hdmaxplayer.video.player.Model.HideData;
import com.kdapps.videoplayer.hdmaxplayer.video.player.R;
import net.halitta.videoplayer.hdmaxplayer.video.player.Util.Constant;
import net.halitta.videoplayer.hdmaxplayer.video.player.Util.Utils;
import net.halitta.videoplayer.hdmaxplayer.video.player.Util.VideoPlayerManager;

import net.halitta.videoplayer.hdmaxplayer.video.player.Fragment.VideoFragment;
...
import static net.halitta.videoplayer.hdmaxplayer.video.player.Fragment.RecentFragment.ivnodata;
import static net.halitta.videoplayer.hdmaxplayer.video.player.Fragment.RecentFragment.recentrecycler;
